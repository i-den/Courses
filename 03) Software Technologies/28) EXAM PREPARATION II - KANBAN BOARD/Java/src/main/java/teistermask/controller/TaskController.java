...
public class TaskController {
    ...
    public String index(Model model) {
        ...
        List<Task> openTasks = filterList(tasks, "Open");
        List<Task> inProgressTasks = filterList(tasks, "In Progress");
        List<Task> finishedTasks = filterList(tasks, "Finished");
    ...
    private List<Task> filterList(List<Task> tasks, String status) {
        List<Task> currentTasksToReturn = tasks
                .stream()
                .filter(t -> t.getStatus().equals(status))
                .collect(Collectors.toList());

        return currentTasksToReturn;
    }
}
