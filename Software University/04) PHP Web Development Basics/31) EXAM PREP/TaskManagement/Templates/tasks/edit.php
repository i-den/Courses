...
<form method="post">
    ...
    Description: <textarea name="description" minlength="10"
                           maxlength="10000"><?= $data->getTask()->getDescription(); ?></textarea><br/>
    Location: <input value="<?= $data->getTask()->getLocation(); ?>" type="text" name="location" minlength="3"
                     maxlength="100"/><br/>
