...
import com.denchevgod.recipes.converters.IngredientCommandToIngredient;
import com.denchevgod.recipes.converters.IngredientToIngredientCommand;
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if(!recipeOptional.isPresent()){
            ...
            if(ingredientOptional.isPresent()){
                ...
                ingredientFound.setUnitOfMeasurement(unitOfMeasureRepository
            ...
            if(!savedIngredientOptional.isPresent()){
                ...
                savedIngredientOptional = savedRecipe.getIngredients().stream()
                        ...
                        .filter(recipeIngredients -> recipeIngredients.getUnitOfMeasurement().getId().equals(command.getUom().getId()))
                        .findFirst();
            }
