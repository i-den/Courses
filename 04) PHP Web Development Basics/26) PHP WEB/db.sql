...
INSERT INTO `cars` VALUES (1,'Audi','A4',2004),(2,'Audi','A4',2004),(3,'BMW','B3',2002),(4,'Audi','A4',2004),(5,'Audi','A4',2004),(8,'Ferarri','Enzo',2017);
/*!40000 ALTER TABLE `cars` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `cars_view`
--
...
INSERT INTO `customers` VALUES (3,'Ivan','Ivanov'),(4,'Ivan','Toshkov'),(6,'Ivan','Denchev');
...
INSERT INTO `sales` VALUES (3,1,3,'2017-10-24 20:14:21','20000'),(4,2,3,'2017-10-28 18:17:29','7000'),(5,3,4,'2017-10-24 20:14:21','asd 25000'),(6,4,4,'2017-10-28 18:27:58','7000'),(7,5,4,'2017-10-28 18:28:51','7000'),(9,8,6,'2017-10-28 18:55:21','7777777');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GET_CARS_FOR_UPDATE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_CARS_FOR_UPDATE`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GET_CUSTOMERS_FOR_UPDATE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_CUSTOMERS_FOR_UPDATE`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GET_SALES_FOR_UPDATE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GET_SALES_FOR_UPDATE`()
BEGIN
    SELECT sale_id, amount, date_sold
    FROM sales;
  END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50001 DROP TABLE IF EXISTS `cars_view`*/;
/*!50001 DROP VIEW IF EXISTS `cars_view`*/;
...
/*!50001 VIEW `cars_view` AS select `cars`.`make` AS `make`,`cars`.`model` AS `model`,`cars`.`year` AS `year` from `cars` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `customers_view` AS select `customers`.`first_name` AS `first_name`,`customers`.`family_name` AS `family_name` from `customers` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `sales_view` AS select `cars`.`make` AS `make`,`cars`.`model` AS `model`,`cars`.`year` AS `year`,`sales`.`date_sold` AS `date_sold`,`sales`.`amount` AS `amount` from (`cars` join `sales` on((`cars`.`car_id` = `sales`.`car_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-10-28 22:00:18
